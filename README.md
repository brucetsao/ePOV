...
這本書以市面常使用Led字幕機為主要開發標基本概念，主要的原理是透過視覺暫留的原理，從一列的Led發光二極體，到一面的Led發光二極體，最後到圓柱體的圓型立體字，主要是產生出環型的視覺效果。所以使用一片的Led發光二極體陣列來產生圓柱體的圓型立體字幕機的效果，其中的巧思，令人心儀。所以本書要以『Arduino 旋轉字幕機開發』來進行產品設計，相信整個研發過程會更加了解。
